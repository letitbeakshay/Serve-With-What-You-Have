// DORMANT — not wired into any route (this folder isn't named "page.tsx",
// so Next never serves it). This was the v1 admin dashboard: a list of
// multiple named forms with a "Create form" input, and the full detailed
// Response table. Kept verbatim for reference in case the onboarding flow
// is upgraded back to the multi-form / detailed-fields version later.
// The current live dashboard is ../page.tsx.
...
export default async function AdminHomePageV1() {
